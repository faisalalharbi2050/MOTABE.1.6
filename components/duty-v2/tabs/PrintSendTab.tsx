    ...
    <div className="space-y-5" dir="rtl">
              ...
              <div className="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className={`relative flex items-center gap-3 px-4 py-3 border-2 rounded-xl bg-white transition-all ${sendChannel === 'whatsapp' ? 'border-slate-200 bg-slate-50' : 'border-slate-200 hover:border-slate-300 hover:bg-slate-50'}`}
                  >
                  ...
                  <button
                    ...
                    className={`relative flex items-center gap-3 px-4 py-3 border-2 rounded-xl bg-white transition-all ${sendChannel === 'sms' ? 'border-slate-200 bg-slate-50' : 'border-slate-200 hover:border-slate-300 hover:bg-slate-50'}`}
                  >
      ...
      <RecipientsPreviewModal
        ...
        recipients={selectedRows.map(row => ({
          id: row.key,
          name: row.staffName,
          subtitle: row.staffType,
          role: row.staffTypeKey,
