...
const SupervisionPreCheckModal: React.FC<Props> = ({ isOpen, onClose, onProceed, onGoToSettings, checks }) => {
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-black text-slate-800">قبل إنشاء الجدول</h3>
        ...
        <div className="px-6 pb-6 flex gap-3">
          ...
          <button
            onClick={onProceed}
            className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-[#655ac1] hover:bg-[#5046a0] text-white text-sm font-bold rounded-xl transition-all shadow-md shadow-[#655ac1]/20 hover:scale-105 active:scale-95"
          >
            <Zap size={16} />
            متابعة الإنشاء
          </button>
...
export default SupervisionPreCheckModal;
