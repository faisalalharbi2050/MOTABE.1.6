...
const GeneralSettingsWizard: React.FC<WizardProps> = ({ 
  ...
  const renderStepContent = () => {
    ...
    switch (currentStep) {
      ...
      case 5: return <Step4Classes classes={classes} setClasses={setClasses} subjects={subjects} setSubjects={setSubjects} gradeSubjectMap={gradeSubjectMap} setGradeSubjectMap={setGradeSubjectMap} phaseDepartmentMap={phaseDepartmentMap} schoolInfo={schoolInfo} setSchoolInfo={setSchoolInfo} assignments={[]} setAssignments={() => undefined} scheduleSettings={scheduleSettings} setScheduleSettings={setScheduleSettings} />;
