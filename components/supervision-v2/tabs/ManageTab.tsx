...
import { SavedSupervisionSchedule, SchoolInfo, SupervisionScheduleData } from '../../../types';
...
const ManageTab: React.FC<Props> = ({ supervisionData, setSupervisionData, showToast, schoolInfo }) => {
