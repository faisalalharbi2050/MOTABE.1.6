...
const DutyManageSchedulesModal: React.FC<Props> = ({
    ...
    if (confirmAction.mode === 'delete') {
      setDutyData(prev => {
        ...
        return {
          ...
          ...(isDeletingActiveSchedule
            ? { dayAssignments: [], weekAssignments: [], dutyAssignmentCounts: {} }
            : {}),
  ...
  const stats = [
    { label: 'إجمالي جداول المناوبة', value: String(createdSchedulesCount) },
  ...
  const confirmTheme =
    confirmAction?.mode === 'delete'
      ? {
          ...
          subtitle: 'سيتم حذف جدول المناوبة المحدد نهائيًا.',
          body: 'هذا الإجراء سيحذف جدول المناوبة الذي تم إنشاؤه',
        }
      : confirmAction?.mode === 'unadopt'
        ? {
            ...
            subtitle: 'سيتم إلغاء اعتماد جدول المناوبة المحدد.',
            body: 'سيبقى الجدول محفوظًا، لكنه لن يكون جدول المناوبة المعتمد حاليًا.',
          }
        : {
            iconWrap: 'bg-[#f1efff] text-[#655ac1]',
            title: 'اعتماد جدول المناوبة',
            button: 'bg-[#655ac1] hover:bg-[#5448b5]',
            subtitle: 'سيتم اعتماد هذا الجدول كجدول مناوبة نشط.',
            body: 'سيصبح هذا الجدول هو جدول المناوبة المعتمد الحالي داخل صفحة إدارة الجداول.',
          };
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-slate-500 mt-0.5">
                عرض وإدارة جميع جداول المناوبة المنشأة
              </p>
            </div>
          </div>
          <button
            ...
            {savedSchedules.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-20 gap-4 text-slate-500">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-slate-500">ابدأ ببناء جدول المناوبة أولًا</p>
                </div>
              </div>
            ) : (
        ...
        <div className="px-6 py-4 border-t border-slate-100 bg-slate-50 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-2 text-slate-400">
            ...
            <span className="text-xs font-bold">
              يُحفظ جدول المناوبة تلقائيًا عند كل إنشاء · الحد الأقصى 10 جداول
            </span>
          </div>
          <button
            onClick={onClose}
