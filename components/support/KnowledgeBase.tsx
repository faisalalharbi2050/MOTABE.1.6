...
const FAQ_DATA: FAQCategory[] = [
  // ── الرئيسية ──────────────────────────────────────────────────────────────
  {
    ...
    label: 'الرئيسية',
    items: [
      { q: 'ماذا تعرض الصفحة الرئيسيɿ', a: 'تعرض الصفحة الرئيسية ملخصاً شاملاً: إحصائيات المعلمين والفصول، جدول اليوم، آخر الرسائل، مؤشر استهلاك رصيد الرسائل، وروابط سريعة للأقسام الرئيسية.' },
      { q: 'هل يمكن التنقل السريع بين الأقسام من الرئيسيɿ', a: 'نعم، توفر الصفحة الرئيسية أزرار وصول سريع للأقسام الأكثر استخداماً كالجدول والرسائل والإشراف والمناوبة.' },
      { q: 'هل تظهر تنبيهات مهمة في الصفحة الرئيسيɿ', a: 'نعم، تظهر تنبيهات اقتراب انتهاء الاشتراߡ واستهلاك الرصيد المجاني للرسائل، وتذكيرات الجداول اليومية بشكل بارز.' },
    ],
  },
  // ── الإعدادات ─────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { q: 'كيف أعدّل اسم المدرسة أو شعارهǿ', a: 'من "الإعدادات والبيانات > بيانات المدرسة" يمكنك تعديل اسم المدرسة والشعار وبقية البيانات الأساسية ثم حفظ التغييرات.' },
      { q: 'كيف أضيف مدرسة مشتركɿ', a: 'من صفحة "بيانات المدرسة" ابحث عن خيار "المدارس المشتركة" وأدخل بيانات المدرسة الثانية.' },
      { q: 'ما البيانات التي يمكن تعديلها في المعلومات العامɿ', a: 'يمكنك تعديل: اسم المدرسɡ الشعاѡ العنوان، رقم الهاتݡ البريد الإلكتروني، والمنطقة التعليمية.' },
    ],
  },
  {
    id: 'settings_timing',
    label: 'التوقيت',
    items: [
      { q: 'كيف أضبط أوقات بداية ونهاية الحصտ', a: 'من "الإعدادات > التوقيت" أضف الحصص وحدد وقت البداية والنهاية لكل حصة على حدة.' },
      { q: 'كيف أضيف فترة فسحة وأحدد مدتهǿ', a: 'من نفس الصفحة انقر "إضافة فسحة" وحدد وقتها ومدتها بالدقائق.' },
      { q: 'هل يمكن تعريف أكثر من فترة زمنيɿ', a: 'نعم، يمكنك إضافة عدة حصص وفسحات وترتيبها وفق جدول المدرسة الفعلي.' },
      { q: 'كيف أحذف أو أعدّل وقت حصة موجودɿ', a: 'انقر أيقونة التعديل بجانب الحصة لتغيير وقتهǡ أو أيقونة الحذف لإزالتها نهائياً.' },
    ],
  },
  {
    ...
    label: 'المواد',
    items: [
      { q: 'كيف أضيف مادة دراسية جديدɿ', a: 'من "الإعدادات > المواد" انقر "إضافة مادة"، أدخل اسمها وحدد الصفوف التي تُدرَّس فيها وعدد حصصها الأسبوعية.' },
      { q: 'كيف أحدد عدد الحصص الأسبوعية لكل مادɿ', a: 'عند إضافة أو تعديل المادة يمكنك تحديد عدد الحصص لكل صف دراسي مرتبط بها.' },
      { q: 'كيف أربط مادة بصف دراسي؟', a: 'من صفحة "المواد" اختر المادة وانقر تعديل، ثم حدد الصفوف الدراسية المرتبطة بها.' },
      { q: 'هل يمكن حذف مادة دراسيɿ', a: 'نعم، لكن تأكد من عدم ارتباطها بإسنادات أو جداول نشطة قبل الحذف.' },
    ],
  },
  {
    id: 'settings_classes',
    ...
    items: [
      ...
      { q: 'كيف أعدّل بيانات فصل موجوϿ', a: 'انقر على أيقونة التعديل بجانب اسم الفصل لتحديث بياناته.' },
  ...
  },
  {
    ...
    label: 'المعلمون',
    items: [
      { q: 'كيف أضيف معلماً جديداً؟', a: 'من "الإعدادات > المعلمون" انقر "إضافة معلم" وأدخل البيانات: الاسم، التخصա النصاȡ ورقم الجوال.' },
      ...
      { q: 'كيف أعدّل بيانات معلم موجوϿ', a: 'ابحث عن المعلم في القائمة وانقر أيقونة التعديل بجانب اسمه لتحديث بياناته.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'كيف أنقل طالباً من فصل إلى آخѿ', a: 'من تعديل بيانات الطالب غيّر الفصل المرتبط به واحفظ التغييرات.' },
  ...
  },
  {
    ...
    label: 'الإداريون',
    items: [
      { q: 'كيف أضيف حساب إداري جديϿ', a: 'من "الإداريون" انقر "إضافة إداري" وأدخل البيانات: الاسم، الدوѡ ورقم الجوال.' },
      { q: 'كيف أعدّل بيانات إداري أو دوره؟', a: 'ابحث عن الإداري وانقر أيقونة التعديل لتحديث بياناته أو تغيير دوره.' },
      { q: 'ما الفرق بين الإداري والمعلم في النظام؟', a: 'المعلم مرتبط بالمواد والجداول الدراسيɡ أما الإداري فيُستخدم في جداول الإشراف والمناوبة دون ارتباط بمواد دراسية.' },
  ...
  // ── الجدول المدرسي ────────────────────────────────────────────────────────
  {
    ...
    label: 'إسناد المواد',
    items: [
      { q: 'كيف أسند مادة لمعلم معين؟', a: 'من صفحة إسناد المواϡ اختر المعلم من القائمة ثم انقر على خلية المادة والفصل في شبكة الفصول. يشترط تحديد معلم أولاً قبل البدء بالإسناد.' },
      { q: 'ماذا تعني بطاقات إحصائيات الإسناϿ', a: 'تعرض البطاقات في أعلى الصفحة عدد الحصص غير المسندɡ عدد الفصول غير المكتملɡ وعدد المواد غير المسندة لمتابعة مدى اكتمال الإسناد.' },
      { q: 'كيف أعرف أن نصاب المعلم سيتجاوز عند الإسناϿ', a: 'يحسب النظام حمل كل معلم تلقائياً، وتظهر رسالة تحذيرية عند محاولة تجاوز النصاب مع إمكانية التأكيد رغم التجاوز.' },
  ...
  // ── الإشراف والمناوبة ─────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { q: 'هل يمكن تسجيل التوقيع الرقمي للمشرݿ', a: 'نعم، يتم إرسال رابط التوقيع عبر واتساب أو SMS للمشرف لتوقيعه إلكترونياً.' },
      ...
      { q: 'هل يمكن استثناء معلم معين من الإشراݿ', a: 'نعم، من إعدادات الجدول يمكنك تحديد المعلمين المُعفَيين وسيتجاهلهم النظام عند التوزيع التلقائي.' },
    ],
  },
  {
    id: 'duty',
    ...
    items: [
      { q: 'كيف أنشئ جدول مناوبة أسبوعي أو شهري؟', a: 'انتقل إلى "المناوبة اليومية" وحدد نطاق الجدول (أسبوڡ أسبوعان، شهر) ثم اختر طريقة التوزيع واضغط "إنشاء الجدول".' },
      { q: 'ما هو تقرير المناوبة اليوميɿ', a: 'التقرير اليومي يُظهر المعلمين والإداريين المناوبين لكل يوم مع مواقعهم. يمكن طباعته أو إرساله مباشرة.' },
  ...
  // ── الانتظار اليومي ───────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { q: 'كيف أُسجل حالات الغياب وأُوزع الحصտ', a: 'من "الانتظار اليومي" أضف حالات الغياب ثم انقر "توزيع تلقائي" لتوزيع الحصص على المعلمين المتاحين.' },
      ...
      { q: 'هل يدعم النظام التوقيع الرقمي لجدول الانتظاѿ', a: 'نعم، يمكن للمعلم توقيع الجدول رقمياً عبر الرابط المرسل إليه ويُحفظ في سجل المنصة.' },
    ],
  },
  // ── الصلاحيات ─────────────────────────────────────────────────────────────
  {
    ...
    label: 'الصلاحيات',
    items: [
      { q: 'كيف أُفوِّض صلاحيات لمستخدم آخѿ', a: 'من "الصلاحيات" انقر "إضافة مفوض"، أدخل بيانات المستخدم وحدد الأقسام التي يمكنه الوصول إليها.' },
  ...
  // ── الرسائل ───────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { q: 'ما عدد الرسائل المجانية في كل باقɿ', a: 'تمنحك كل باقة رصيداً مجانياً أولياً يتضمن 10 رسائل SMS و50 رسالة واتساب.' },
      { q: 'هل يمكن جدولة الرسائل لإرسالها في وقت محدϿ', a: 'نعم، فعّل خيار "جدولة الإرسال" عند إنشاء الرسالة وحدد التاريخ والوقت المناسبين.' },
      ...
      { q: 'هل يتم حفظ الرسائل المُرسَلɿ', a: 'نعم، جميع الرسائل محفوظة في "أرشيف الرسائل" مع تاريخ الإرسال وحالة التوصيل.' },
    ],
  },
  // ── الاشتراك والفوترة ─────────────────────────────────────────────────────
  {
    ...
    items: [
      { q: 'ما الباقات المتاحة وأسعارهǿ', a: 'تتوفر باقتان: الأساسية والمتقدمة. يمكنك الاطلاع على التفاصيل والأسعار من "الاشتراك والفوترة > الباقات".' },
      { q: 'هل يمكن إلغاء الاشتراك في أي وقʿ', a: 'للإلغاء تواصل مع فريق الدعم الفني. سيظل اشتراكك فعالاً حتى نهاية الفترة المدفوعة.' },
      { q: 'ما وسائل الدفع المدعومɿ', a: 'تدعم المنصة: مدى، فيزǡ ماستركارϡ Apple Pay، Samsung Pay.' },
      { q: 'كيف أحصل على فاتورة ضريبيɿ', a: 'فواتيرك متاحة في "الاشتراك والفوترة > الفواتير" للمعاينة والطباعة أو التحميل بصيغة PDF.' },
      { q: 'ماذا يحدث عند ترقية الباقة أثناء اشتراك نشؿ', a: 'يحتسب النظام الرصيد المتبقي ويخصمه تلقائياً من سعر الباقة الجديدة (Pro-rata).' },
    ],
  },
];
...
const VIDEO_CATEGORIES = [
  ...
  { id: 'settings_basic',   label: 'بيانات المدرسة' },
