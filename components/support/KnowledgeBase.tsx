...
const FAQ_DATA: FAQCategory[] = [
  ...
  // ── الإعدادات ─────────────────────────────────────────────────────────────
  {
    ...
    label: 'معلومات عامة',
    items: [
      { q: 'كيف أعدّل اسم المدرسة أو شعارهǿ', a: 'من "الإعدادات > معلومات عامة" يمكنك تعديل اسم المدرسة والشعار وبقية البيانات الأساسية ثم حفظ التغييرات.' },
      { q: 'كيف أضيف مدرسة مشتركɿ', a: 'من صفحة "معلومات عامة" ابحث عن خيار "المدارس المشتركة" وأدخل بيانات المدرسة الثانية.' },
