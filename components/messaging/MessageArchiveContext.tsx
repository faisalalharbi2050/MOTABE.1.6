...
const INITIAL_TEMPLATES: MessageTemplate[] = [
  ...
  { id: 't2', title: 'تأخر طالب', content: 'المكرم ولي أمر الطالب {اسم_الطالب}، نود إشعاركم بتأخر ابنكم  هذا اليوم {اليوم} وحضوره في الوقت ( س - د )', isSystem: true, category: 'تأخر طالب' },
