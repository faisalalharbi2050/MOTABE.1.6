...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      ...
      case 'settings_classes': return <Step4Classes classes={classes} setClasses={setClasses} subjects={subjects} setSubjects={setSubjects} gradeSubjectMap={gradeSubjectMap} setGradeSubjectMap={setGradeSubjectMap} phaseDepartmentMap={phaseDepartmentMap} schoolInfo={schoolInfo} setSchoolInfo={setSchoolInfo} assignments={assignments} setAssignments={setAssignments} scheduleSettings={scheduleSettings} setScheduleSettings={setScheduleSettings} />;
